...
To build it, just navigate to the FOOSIEngine directory, and firstly, run `cmake .`, then `make`, then navigate to thr `game` directory and run `build/game`. This should hopefully work. Please drop an issue if you need help, I'll try to get to you.
